...
def capture_one_episode(dt, max_timesteps, camera_names, dataset_dir, dataset_name, overwrite):
    ...
    while actions:
        ...
        ts = timesteps.pop(0)
        data_dict['/observations/depth'].append(ts.observation['depth'])
    ...
    # with h5py.File(dataset_path + '.hdf5', 'w') as root:
        ...
        _ = obs.create_dataset('depth', (max_timesteps,480,640),dtype='uint16',chunks=(1, 480, 640),)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--task_name', action='store', type=str, help='Task name.', default='aloha_wear_shoe',required=False)
