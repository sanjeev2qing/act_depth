...
from robot_utils import Recorder, ImageRecorder,DepthRecorder
...
class RealEnv:
    ...
    Observation space: {"qpos": Concat[ left_arm_qpos (6),          # absolute joint position
                        ...
                        "depth":{"depth":(480*640)               # h, w, c, dtype='uint16'}
    """
    ...
    def __init__(self, init_node, setup_robots=True):
        ...
        self.depth_recorder = DepthRecorder(init_node=False)
    ...
    def get_depth(self):
        return self.depth_recorder.get_depth()
